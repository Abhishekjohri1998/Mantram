...
${brief ? `CREATIVE BRIEF: ${brief}` : ''}`;
        ...
        try {
            ...
            // For non-standard ratios (21:9 etc.) pass a customSize so Sharp crops to exact pixels.
            ...
            // For 21:9 / custom ratios: generate at nearest landscape/portrait, then crop to exact ratio
            // We compute a target pixel size — Gemini crops to this via Sharp in internalGenerateCreative
            ...
            const result = await routedImageGenerate(
                ...
                customSizeForCrop  // triggers Sharp crop to exact ratio for 21:9 etc.
            );
