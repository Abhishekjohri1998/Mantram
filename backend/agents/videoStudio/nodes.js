...
export async function ugcPromptBuilderNode(state) {
    ...
    const userPrompt = [
        ...
        `Example: DIALOGUE [curious, questioning]: "Has anyone else been dealing with this or is it just me?"`,
        `Example: DIALOGUE [excited, rising energy]: "I literally wear this every event!"`,
        settings.language && settings.language !== 'English' ? `Example (${settings.language}): Write the dialogue directly in ${settings.language} script/characters.` : '',
