...
export async function ugcPromptBuilderNode(state) {
    ...
    const userPrompt = [
        ...
        `DIALOGUE: "[exact words the presenter says in ${settings.language || 'English'}]"`,
        `Write at least 4-6 distinct DIALOGUE lines across different shots. Each DIALOGUE line must sound natural, colloquial and conversational in ${settings.language || 'English'} — NOT translated from English.`,
