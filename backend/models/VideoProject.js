...
const videoProjectSchema = new mongoose.Schema({
    ...
    generation: {
        ...
        _atlasCloudPayload: { type: mongoose.Schema.Types.Mixed },
        _atlasCloudRetryCount: { type: Number, default: 0 },
        _piApiPayload: { type: mongoose.Schema.Types.Mixed },
        _piApiRetryCount: { type: Number, default: 0 },
        _muApiPayload: { type: mongoose.Schema.Types.Mixed },
        _muApiRetryCount: { type: Number, default: 0 },
        _laozhangVideoUrl: { type: String, default: '' },
        _originalVideoUrl: { type: String, default: '' },
        videoUrl: { type: String, default: '' },
