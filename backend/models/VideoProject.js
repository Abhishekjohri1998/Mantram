...
const videoProjectSchema = new mongoose.Schema({
    ...
    routing: {
        selectedModel: { type: String, enum: ['veo-3.1', 'veo-3.1-fast', 'kling-3.0', 'kling-3.0-o', 'seedance-2.0', 'seedance-2.0-fast', 'seedance-1.0', 'grok-imagine', 'hunyuan', 'sora-2', 'happyhorse-1.0', 'happyhorse-1.1', 'gemini-flash', 'gemini-omni-flash', 'heygen', 'heygen-photo-avatar', 'heygen-product-placement', 'heygen-audio-avatar', 'heygen-video-agent'], default: 'kling-3.0' },
