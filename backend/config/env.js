...
export default {
    ...
    ai: {
        ...
        defaultTextModel: process.env.DEFAULT_TEXT_MODEL || 'claude-3-5-sonnet-20240620',
        ...
        defaultAnthropicModel: process.env.DEFAULT_ANTHROPIC_MODEL || 'claude-3-5-sonnet-20240620',
