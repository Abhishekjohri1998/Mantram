        ...
        <div className="min-h-screen flex items-center justify-center relative" style={{ background: '#0a0c16' }}>
            ...
            <div className="relative z-10 w-full max-w-md px-6">
                ...
                <div className="glass-panel rounded-2xl p-8">
                    ...
                    {/* Google OAuth */}
                    <button className="w-full flex items-center justify-center gap-3 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-white text-sm font-medium hover:bg-white/[0.06] transition-all cursor-pointer">
