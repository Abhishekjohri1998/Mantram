export const NODE_PARAM_SCHEMAS = {
    video_generate: {
        model:       { type: 'enum',   label: 'Model',        options: ['seedance-2.0','kling-3.0','veo-3.1','veo-3.1-fast','grok-imagine','gemini-flash'] },
    ...
    prompt_expand: {
        targetModel: { type: 'enum',   label: 'Target Model',  options: ['seedance-2.0','kling-3.0','veo-3.1','veo-3.1-fast','grok-imagine','gemini-flash'] },
