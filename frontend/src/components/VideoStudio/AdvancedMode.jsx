...
const MODELS = {
    ...
    'seedance-2.0-mini': { id: 'seedance-2.0-mini', name: 'Seedance 2.0 Mini', msIcon: 'movie_filter', durs: [5, 10, 15, 20, 30, 45], ratios: ['16:9', '9:16', '1:1', '4:3', '21:9'], res: ['720p', '480p'], has: { firstFrame: true, refImages: true, refVideo: true, refAudio: true, audio: true, quality: false, multiRefImages: 9, negativePrompt: true, seed: true, cfgScale: true }, cost: 0.03, desc: "ByteDance Seedance 2.0 Mini — lightweight, low-cost video generation." },
    ...
    'gemini-omni-flash-edit': { id: 'gemini-omni-flash-edit', name: 'Gemini Video Edit', msIcon: 'edit', durs: [4, 6, 8, 10], ratios: ['16:9', '9:16'], res: ['1080p', '720p', '480p'], has: { firstFrame: true, refImages: true, audio: true, quality: false }, cost: 0.14, desc: "DeepMind Video Edit model via Atlas Cloud — edits video using text prompts and reference images." },
    'gemini-omni-flash-r2v-dev': { id: 'gemini-omni-flash-r2v-dev', name: 'Gemini Ref-to-Video Dev', msIcon: 'transform', durs: [4, 6, 8, 10, 15], ratios: ['16:9', '9:16'], res: ['1080p', '720p', '480p'], has: { firstFrame: true, refImages: true, audio: true, quality: false }, cost: 0.12, desc: "DeepMind Reference-to-Video Developer model — transforms clip styling guided by references." },
    'kling-video-o3-pro': { id: 'kling-video-o3-pro', name: 'Kling Video O3 Pro', msIcon: 'movie_filter', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['4k', '1080p', '720p'], has: { firstFrame: true, lastFrame: true, audio: true, quality: true, multishot: true }, cost: 0.112, desc: "Kling Omni Video O3 professional grade cinematic quality." },
    'kling-video-o3-std': { id: 'kling-video-o3-std', name: 'Kling Video O3 Std', msIcon: 'movie_filter', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: true, audio: true, quality: true, multishot: true }, cost: 0.084, desc: "Kling Omni Video O3 standard quality model." },
    'kling-video-o3-4k': { id: 'kling-video-o3-4k', name: 'Kling Video O3 4K', msIcon: 'hd', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['4k', '1080p', '720p'], has: { firstFrame: true, lastFrame: true, audio: true, quality: true, multishot: true }, cost: 0.42, desc: "Kling Omni Video O3 Ultra 4K high fidelity generator." },
    'kling-video-o1': { id: 'kling-video-o1', name: 'Kling Video O1', msIcon: 'psychology', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.112, desc: "Kling O1 physics model — realistic interactions and movement." },
    'kling-3.0-turbo': { id: 'kling-3.0-turbo', name: 'Kling 3.0 Turbo', msIcon: 'bolt', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: true, audio: true, quality: true, multishot: true }, cost: 0.112, desc: "Kling v3.0 Turbo model for rapid storyboard drafting." },
    'kling-3.0-4k': { id: 'kling-3.0-4k', name: 'Kling v3.0 4K', msIcon: 'hd', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['4k', '1080p', '720p'], has: { firstFrame: true, lastFrame: true, audio: true, quality: true, multishot: true }, cost: 0.42, desc: "Kling v3.0 Ultra 4K rendering model." },
    'kling-3.0-pro': { id: 'kling-3.0-pro', name: 'Kling v3.0 Pro', msIcon: 'videocam', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: true, audio: true, quality: true, multishot: true }, cost: 0.112, desc: "Kling v3.0 Professional Grade model." },
    'kling-3.0-std': { id: 'kling-3.0-std', name: 'Kling v3.0 Standard', msIcon: 'videocam', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: true, audio: true, quality: true, multishot: true }, cost: 0.084, desc: "Kling v3.0 Standard model." },
    'kling-2.6-pro-avatar': { id: 'kling-2.6-pro-avatar', name: 'Kling v2.6 Pro Avatar', msIcon: 'account_circle', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.112, desc: "Kling v2.6 Pro talking head portrait avatar generator." },
    'kling-2.6-std-avatar': { id: 'kling-2.6-std-avatar', name: 'Kling v2.6 Std Avatar', msIcon: 'account_circle', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.056, desc: "Kling v2.6 Standard talking head portrait generator." },
    'kling-2.6-pro-motion': { id: 'kling-2.6-pro-motion', name: 'Kling v2.6 Pro Motion', msIcon: 'directions_walk', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.112, desc: "Kling v2.6 Pro motion transfer control mapping model." },
    'kling-2.6-std-motion': { id: 'kling-2.6-std-motion', name: 'Kling v2.6 Std Motion', msIcon: 'directions_walk', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.07, desc: "Kling v2.6 Standard motion transfer control mapping model." },
    'kling-2.5-turbo-pro': { id: 'kling-2.5-turbo-pro', name: 'Kling v2.5 Turbo Pro', msIcon: 'speed', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.07, desc: "Kling v2.5 Turbo Pro model — high speed cinematic clips." },
    'kling-2.1-i2v-pro-start-end': { id: 'kling-2.1-i2v-pro-start-end', name: 'Kling v2.1 Start-End', msIcon: 'swap_horiz', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: true, audio: true, quality: false }, cost: 0.098, desc: "Kling v2.1 Pro Start-End Frame model — morphs two keyframes." },
    'kling-2.1-t2v-master': { id: 'kling-2.1-t2v-master', name: 'Kling v2.1 T2V Master', msIcon: 'workspace_premium', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: false, lastFrame: false, audio: true, quality: false }, cost: 0.28, desc: "Kling v2.1 Text-to-Video Master model — premium lighting." },
    'kling-2.0-t2v-master': { id: 'kling-2.0-t2v-master', name: 'Kling v2.0 T2V Master', msIcon: 'workspace_premium', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: false, lastFrame: false, audio: true, quality: false }, cost: 0.28, desc: "Kling v2.0 Text-to-Video Master model — detailed scenes." },
    'kling-2.1-i2v-master': { id: 'kling-2.1-i2v-master', name: 'Kling v2.1 I2V Master', msIcon: 'workspace_premium', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.28, desc: "Kling v2.1 Image-to-Video Master model — high fidelity." },
    'kling-2.0-i2v-master': { id: 'kling-2.0-i2v-master', name: 'Kling v2.0 I2V Master', msIcon: 'workspace_premium', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.28, desc: "Kling v2.0 Image-to-Video Master model — skin textures." },
    'kling-2.1-i2v-pro': { id: 'kling-2.1-i2v-pro', name: 'Kling v2.1 I2V Pro', msIcon: 'star', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.098, desc: "Kling v2.1 Image-to-Video Professional model." },
    'kling-2.1-i2v-std': { id: 'kling-2.1-i2v-std', name: 'Kling v2.1 I2V Standard', msIcon: 'star_border', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.056, desc: "Kling v2.1 Image-to-Video Standard model." },
    'kling-1.6-multi-i2v-pro': { id: 'kling-1.6-multi-i2v-pro', name: 'Kling v1.6 Multi Pro', msIcon: 'group', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.098, desc: "Kling v1.6 Multi Image-to-Video Pro — multi-subject consistency." },
    'kling-1.6-multi-i2v-std': { id: 'kling-1.6-multi-i2v-std', name: 'Kling v1.6 Multi Standard', msIcon: 'group', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.056, desc: "Kling v1.6 Multi Image-to-Video Standard." },
    'kling-1.6-t2v-std': { id: 'kling-1.6-t2v-std', name: 'Kling v1.6 T2V Standard', msIcon: 'videocam', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: false, lastFrame: false, audio: true, quality: false }, cost: 0.056, desc: "Kling v1.6 Text-to-Video Standard model." },
    'kling-1.6-i2v-pro': { id: 'kling-1.6-i2v-pro', name: 'Kling v1.6 I2V Pro', msIcon: 'star', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.098, desc: "Kling v1.6 Image-to-Video Professional model." },
    'kling-1.6-i2v-std': { id: 'kling-1.6-i2v-std', name: 'Kling v1.6 I2V Standard', msIcon: 'star_border', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.056, desc: "Kling v1.6 Image-to-Video Standard model." },
    'kling-effects': { id: 'kling-effects', name: 'Kling Effects', msIcon: 'auto_awesome', durs: [5, 10, 15], ratios: ['16:9', '9:16', '1:1'], res: ['1080p', '720p'], has: { firstFrame: true, lastFrame: false, audio: true, quality: false }, cost: 0.25, desc: "Kling Effects model — VFX and transitions." },
}
                        ...
                        <div className="vm-bottom-left">
                            ...
                            <div className="vm-slider-container" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '0 12px', background: 'var(--sys-surface-glass)', borderRadius: '10px', height: '36px', border: '1px solid var(--sys-border)' }}>
                                ...
                                <input
                                    ...
                                    max={m.durs ? m.durs[m.durs.length - 1] : 120}
                                    step={1}
                                    value={duration}
                                    onChange={e => {
