...
const MODELS = {
    ...
    'seedance-2.0-mini': { id: 'seedance-2.0-mini', name: 'Seedance 2.0 Mini', msIcon: 'movie_filter', durs: [5, 10, 15, 20, 30, 45, 60, 90, 120], ratios: ['16:9', '9:16', '1:1', '4:3', '21:9'], res: ['720p', '480p'], has: { firstFrame: true, refImages: true, refVideo: true, refAudio: true, audio: true, quality: false, multiRefImages: 9, negativePrompt: true, seed: true, cfgScale: true }, cost: 0.03, desc: "ByteDance Seedance 2.0 Mini — lightweight, low-cost video generation." },
