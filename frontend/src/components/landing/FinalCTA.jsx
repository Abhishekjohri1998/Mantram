 ...
 */
export default function FinalCTA({ onEarlyAccess, onAgencyDemo }) {
    const ref = useReveal()
    return (
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-3">
                    ...
                    <button
                        ...
                        className="px-8 py-4 rounded-full font-bold text-sm transition-all hover:scale-105 active:scale-95 cursor-pointer"
                        style={{
