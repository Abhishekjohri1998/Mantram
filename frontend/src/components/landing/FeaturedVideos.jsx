        ...
        <section className="relative w-full overflow-hidden pb-20 pt-4 -mt-10 z-10" ref={revealRef}>
            ...
            >
                {featuredItems.map((item) => (
                    <div 
                        key={item.id}
                        className="snap-center shrink-0 w-[280px] md:w-[340px] aspect-[4/5] rounded-[24px] relative group cursor-pointer transition-transform duration-500 hover:-translate-y-4 shadow-2xl overflow-hidden"
