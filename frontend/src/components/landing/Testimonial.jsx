...
export default function Testimonial() {
    ...
    return (
        ...
        >
            <div ref={revealRef} className="max-w-7xl mx-auto px-4 md:px-6 flex flex-col lg:flex-row items-center gap-16 lg:gap-24" style={{ transformStyle: 'preserve-3d' }}>
                
                {/* Left side: Quote — forward in Z-space */}
                <div className="flex-1 w-full relative z-10" style={{ transform: 'translateZ(40px)' }}>
                ...
                {/* Right side: Visual Portrait — slightly recessed in Z-space */}
                <div className="w-full lg:w-[420px] shrink-0" style={{ transform: 'translateZ(-20px)' }}>
