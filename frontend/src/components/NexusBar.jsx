            ...
            <div className="fixed bottom-6 right-6 z-[9999]" ref={dropdownRef}>
                    ...
                    <div className={`absolute bottom-16 right-0 rounded-2xl overflow-hidden animate-fade-in
                            ...
                            {streamingText && (
                                <div className="flex gap-2.5">
                                    ...
                                    <div className="max-w-[85%] px-3 py-2 rounded-2xl rounded-bl-sm bg-white/[0.05] border border-white/[0.06] text-[13px] text-slate-200 leading-relaxed"
                                        style={{ whiteSpace: 'pre-wrap' }}>
                                        {streamingText}
                                        <span className="inline-block w-1.5 h-4 bg-violet-400 ml-0.5 rounded-sm animate-pulse" />
                                    </div>
                                </div>
                            )}
                                ...
                                <div className="flex gap-2.5">
                                    ...
                                    <div className="px-3 py-2 rounded-2xl rounded-bl-sm bg-white/[0.05] border border-white/[0.06]">
                                        <div className="flex gap-1">
                                            ...
                                            <span className="size-1.5 rounded-full bg-pink-400 animate-bounce" style={{ animationDelay: '150ms' }} />
                            ...
                            <div className="px-4 pb-2 flex flex-wrap gap-1.5 border-t border-white/[0.04] pt-2.5">
                                {suggestions.map((q, i) => (
                                    <button key={i} onClick={() => sendMessage(q)}
                                        className="px-2.5 py-1.5 rounded-lg bg-violet-500/8 text-violet-300 text-[11px] border border-violet-500/12 hover:bg-violet-500/15 cursor-pointer transition-all">
                                        {q}
                                    </button>
                                ))}
                            </div>
                        ...
                        <div className="px-3 py-2.5 border-t border-white/[0.06] flex items-center gap-2">
                            <input
                                ...
                                className="flex-1 bg-white/[0.04] rounded-xl px-3 py-2 text-sm text-white placeholder-slate-500 outline-none border border-white/[0.06] focus:border-violet-500/30 transition-all"
                            />
                            {/* Mic */}
                            <button
                            ...
                            <button
                                ...
                                className={`p-2 rounded-xl transition-all cursor-pointer flex-shrink-0 ${input.trim()
                                    ? 'text-violet-400 hover:text-white hover:bg-violet-500/15'
                ...
                <button
                    ...
                    style={{
                        ...
                        boxShadow: '0 8px 32px rgba(139, 92, 246, 0.4), 0 0 20px rgba(139, 92, 246, 0.15)',
                    }}
