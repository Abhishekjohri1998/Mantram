        ...
        <div className="min-h-screen bg-[var(--sys-surface)] text-[var(--sys-text-muted)] py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-extrabold text-[var(--sys-text)] mb-4">Privacy <span className="text-primary">Policy</span></h1>
                ...
                <div className="glass-panel rounded-3xl p-8 space-y-8 border border-[var(--sys-border)]">
                    ...
                    {/* 1 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">1. Information We Collect</h2>

                        <h3 className="text-lg font-semibold text-[var(--sys-text)]/80 mt-4 mb-2">1.1 Information You Provide</h3>
                        ...
                        <h3 className="text-lg font-semibold text-[var(--sys-text)]/80 mt-5 mb-2">1.2 Automatically Collected Information</h3>
                        <ul className="list-disc list-inside space-y-1.5 text-sm pl-2">
                            <li><strong className="text-[var(--sys-text)]/90">Device Data:</strong> Browser type, OS, screen resolution, device identifiers</li>
                            <li><strong className="text-[var(--sys-text)]/90">Usage Data:</strong> Pages visited, features used, content generated, session duration</li>
                            <li><strong className="text-[var(--sys-text)]/90">IP Address:</strong> Approximate geographic location for analytics and security</li>
                            <li><strong className="text-[var(--sys-text)]/90">Cookies:</strong> Session management, preference storage, analytics (see Section 8)</li>
                        </ul>

                        <h3 className="text-lg font-semibold text-[var(--sys-text)]/80 mt-5 mb-2">1.3 Third-Party Platform Data</h3>
                        <p className="leading-relaxed">
                    ...
                    {/* 2 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">2. Social Media Integration</h2>
                        ...
                        <p className="leading-relaxed mt-3">
                            We only use this information to provide the publishing, analytics, and auto-response services you explicitly initiate. We <strong className="text-[var(--sys-text)]/90">do not</strong> independently post, modify, or delete your social content without your express action.
                        </p>
                    </section>

                    {/* 3 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">3. Google Analytics & Search Console Data</h2>
                        <p className="leading-relaxed mb-3">
                    ...
                    {/* 4 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">4. Shopify Integration</h2>
                        <p className="leading-relaxed">
                    ...
                    {/* 5 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">5. How We Use Your Information</h2>
                        <ul className="list-disc list-inside space-y-1.5 text-sm pl-2">
                            <li><strong className="text-[var(--sys-text)]/90">Service Delivery:</strong> Powering AI studios, generating content, publishing to social platforms, and providing analytics</li>
                            <li><strong className="text-[var(--sys-text)]/90">Brand Intelligence:</strong> Processing your Brand DNA data to ensure AI-generated content matches your brand identity</li>
                            <li><strong className="text-[var(--sys-text)]/90">AI Model Routing:</strong> Selecting optimal AI models (Gemini, Claude, GPT-4o, Grok, Imagen) for each task</li>
                            <li><strong className="text-[var(--sys-text)]/90">Platform Improvement:</strong> Analyzing usage patterns to optimize features and user experience</li>
                            <li><strong className="text-[var(--sys-text)]/90">Communication:</strong> Sending service updates, feature announcements, and support responses</li>
                            <li><strong className="text-[var(--sys-text)]/90">Security:</strong> Detecting fraud, preventing unauthorized access, and protecting platform integrity</li>
                            <li><strong className="text-[var(--sys-text)]/90">Legal Compliance:</strong> Adhering to applicable laws, regulations, and legal processes</li>
                        </ul>
                    </section>

                    {/* 6 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">6. Data Sharing & Disclosure</h2>
                        <p className="leading-relaxed mb-3"><strong className="text-[var(--sys-text)]/90">We do not sell, rent, or trade your personal information.</strong></p>
                        <p className="leading-relaxed mb-2">We may share information only in these circumstances:</p>
                        <ul className="list-disc list-inside space-y-1.5 text-sm pl-2">
                            <li><strong className="text-[var(--sys-text)]/90">AI Model Providers:</strong> Content prompts and generation requests are sent to third-party AI providers (Google, Anthropic, OpenAI, xAI) to deliver services. We do not send personal account data to these providers.</li>
                            <li><strong className="text-[var(--sys-text)]/90">Payment Processors:</strong> Razorpay processes payment transactions securely. We do not store credit card numbers.</li>
                            <li><strong className="text-[var(--sys-text)]/90">Platform APIs:</strong> When you explicitly publish content, data is sent to the target platform (Meta, Instagram, YouTube, Shopify).</li>
                            <li><strong className="text-[var(--sys-text)]/90">Legal Requirements:</strong> When required by law, court order, or governmental authority.</li>
                            <li><strong className="text-[var(--sys-text)]/90">Business Transfers:</strong> In connection with a merger, acquisition, or sale of assets.</li>
                        </ul>
                    </section>

                    {/* 7 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">7. Data Security</h2>
                    ...
                    {/* 8 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">8. Cookies & Tracking</h2>
                        <ul className="list-disc list-inside space-y-1.5 text-sm pl-2">
                            <li><strong className="text-[var(--sys-text)]/90">Essential Cookies:</strong> Authentication, session management, and security</li>
                            <li><strong className="text-[var(--sys-text)]/90">Functional Cookies:</strong> Remembering your preferences, active brand, and UI settings</li>
                            <li><strong className="text-[var(--sys-text)]/90">Analytics Cookies:</strong> Understanding usage patterns to improve the platform</li>
                        </ul>
                        <p className="leading-relaxed mt-3 text-sm">
                    ...
                    {/* 9 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">9. Your Rights</h2>
                        <p className="leading-relaxed mb-3">Depending on your jurisdiction, you may have the right to:</p>
                        <ul className="list-disc list-inside space-y-1.5 text-sm pl-2">
                            <li><strong className="text-[var(--sys-text)]/90">Access:</strong> Request a copy of your personal data</li>
                            <li><strong className="text-[var(--sys-text)]/90">Rectification:</strong> Request correction of inaccurate data</li>
                            <li><strong className="text-[var(--sys-text)]/90">Deletion:</strong> Request deletion of your account and data (see Section 10)</li>
                            <li><strong className="text-[var(--sys-text)]/90">Data Portability:</strong> Request your data in a machine-readable format</li>
                            <li><strong className="text-[var(--sys-text)]/90">Opt-Out:</strong> Unsubscribe from marketing communications at any time</li>
                            <li><strong className="text-[var(--sys-text)]/90">Disconnect:</strong> Revoke social media and third-party integrations via the Integrations tab</li>
                        </ul>
                        <p className="leading-relaxed mt-3 text-sm">
                    ...
                    {/* 10 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">10. Data Deletion</h2>
                        <p className="leading-relaxed mb-3">You can request data deletion in two ways:</p>
                        <ul className="list-disc list-inside space-y-1.5 text-sm pl-2">
                            <li><strong className="text-[var(--sys-text)]/90">Via Dashboard:</strong> Navigate to Settings → Integrations to disconnect social accounts and revoke access tokens immediately</li>
                            <li><strong className="text-[var(--sys-text)]/90">Via Email:</strong> Send a request to <a href="mailto:support@mantram.ai" className="text-primary hover:underline">support@mantram.ai</a> with the subject "Data Deletion Request." We process requests within 48 hours.</li>
                        </ul>
                        <p className="leading-relaxed mt-3 text-sm">
                    ...
                    {/* 11 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">11. Data Retention</h2>
                        <ul className="list-disc list-inside space-y-1.5 text-sm pl-2">
                            <li><strong className="text-[var(--sys-text)]/90">Account Data:</strong> Retained while your account is active, deleted within 30 days of account deletion request</li>
                            <li><strong className="text-[var(--sys-text)]/90">Generated Content:</strong> Stored until you delete it or close your account</li>
                            <li><strong className="text-[var(--sys-text)]/90">Analytics Data:</strong> Aggregated and anonymized data may be retained indefinitely for platform improvement</li>
                            <li><strong className="text-[var(--sys-text)]/90">Payment Records:</strong> Retained for up to 7 years for tax and legal compliance</li>
                        </ul>
                    </section>

                    {/* 12 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">12. Children's Privacy</h2>
                        <p className="leading-relaxed">
                    ...
                    {/* 13 */}
                    <section>
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">13. Changes to This Policy</h2>
                        <p className="leading-relaxed">
                    ...
                    <section className="pt-6 border-t border-[var(--sys-border)]">
                        <h2 className="text-xl font-bold text-[var(--sys-text)] mb-3">14. Contact Us</h2>
