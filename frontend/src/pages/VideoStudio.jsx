                ...
                {playingVideo && (
                    <div className="fixed inset-0 z-[100000] flex items-center justify-center bg-black/80 backdrop-blur-md " onClick={() => setPlayingVideo(null)}>
                        <div className="relative max-w-4xl w-full mx-4" onClick={e => e.stopPropagation()}>
                            <video src={playingVideo} controls autoPlay ref={el => { if(el){ el.muted=false; el.volume=1; } }} className="max-w-full max-h-[85vh] mx-auto rounded-2xl shadow-none object-contain bg-black" />
