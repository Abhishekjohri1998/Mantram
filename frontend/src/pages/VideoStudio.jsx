                        ...
                        <div className="space-y-6">
                                ...
                                AI recommended <strong className="video-highlight-text">{
                                    ...
                                    routing.selectedModel === 'veo-3.1' ? 'Google Veo 3.1' :
                                        routing.selectedModel === 'veo-3.1-fast' ? 'Google Veo 3.1 Fast' :
                                            routing.selectedModel === 'veo-3.1-lite' ? 'Google Veo 3.1 Lite' :
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                {[
                                    ...
                                    { id: 'veo-3.1-lite', name: 'Veo 3.1 Lite', icon: 'movie', desc: 'Google Veo 3.1 Lite model via Atlas Cloud — high efficiency, native audio + ref images', bestFor: 'High-volume campaign videos, product showcases with narration', features: ['ref-images', 'i2v', 'native-audio', '4-8s'], available: true, recommended: true },
                                    ...
                                    { id: 'gemini-omni-flash-edit', name: 'Gemini Omni Video Edit', icon: 'edit', desc: 'Google Gemini Omni Flash Video Edit model via Atlas Cloud — style transfer and video editing from prompts', bestFor: 'Video modification, style overlays, character updates', features: ['ref-images', 'i2v', 'video-edit', '4-10s'], available: true, recommended: false },
                                    { id: 'gemini-omni-flash-r2v-dev', name: 'Gemini Ref-to-Video Dev', icon: 'transform', desc: 'Google Gemini Omni Flash Reference-to-Video Developer model — transforms clips based on reference styles', bestFor: 'Cinematic video style transfer, prompt-guided shifts', features: ['ref-images', 'r2v', '4-15s'], available: true, recommended: false },
                                    { id: 'kling-video-o3-pro', name: 'Kling Video O3 Pro', icon: 'movie_filter', desc: 'Kling Omni Video O3 Professional version — highest cinematic quality', bestFor: 'High-end advertisements, movie-grade visual realism', features: ['multi-shot', 'native-audio', 'voice-ids', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-video-o3-std', name: 'Kling Video O3 Std', icon: 'movie_filter', desc: 'Kling Omni Video O3 Standard version — cost-balanced realism', bestFor: 'Standard cinematic animation, social posts', features: ['multi-shot', 'native-audio', 'voice-ids', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-video-o3-4k', name: 'Kling Video O3 4K', icon: 'hd', desc: 'Kling Omni Video O3 Ultra 4K rendering', bestFor: '4K commercial outputs and high detail projects', features: ['multi-shot', 'native-audio', '4k', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-video-o1', name: 'Kling Video O1', icon: 'psychology', desc: 'Kling O1 physics model — precise movement & realism consistency', bestFor: 'Complex physics actions, temporal coherence', features: ['physics-engine', 'coherence', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-3.0-turbo', name: 'Kling 3.0 Turbo', icon: 'bolt', desc: 'Kling v3.0 Turbo model — rapid standard video renders', bestFor: 'Draft clips, fast animation tests', features: ['fast', 'native-audio', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-3.0-4k', name: 'Kling v3.0 4K', icon: 'hd', desc: 'Kling v3.0 Ultra 4K model', bestFor: 'High resolution 4K renders', features: ['4k', 'native-audio', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-3.0-pro', name: 'Kling v3.0 Pro', icon: 'videocam', desc: 'Kling v3.0 Professional Grade model', bestFor: 'Storyboard animation, high fidelity shots', features: ['multi-shot', 'native-audio', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-3.0-std', name: 'Kling v3.0 Standard', icon: 'videocam', desc: 'Kling v3.0 Standard model', bestFor: 'Social drafts, content layouts', features: ['native-audio', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.6-pro-avatar', name: 'Kling v2.6 Pro Avatar', icon: 'account_circle', desc: 'Kling v2.6 Pro Avatar talking head portrait generator', bestFor: 'Talking head reels, digital avatar speaking', features: ['avatar', 'talking-head', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.6-std-avatar', name: 'Kling v2.6 Standard Avatar', icon: 'account_circle', desc: 'Kling v2.6 Standard Avatar talking head generator', bestFor: 'Quick digital presentation avatars', features: ['avatar', 'talking-head', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.6-pro-motion', name: 'Kling v2.6 Pro Motion', icon: 'directions_walk', desc: 'Kling v2.6 Pro Motion Control transfer model', bestFor: 'Action matching, precise gesture transfers', features: ['motion-transfer', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.6-std-motion', name: 'Kling v2.6 Standard Motion', icon: 'directions_walk', desc: 'Kling v2.6 Standard Motion Control transfer model', bestFor: 'Basic dance transfer, action syncs', features: ['motion-transfer', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.5-turbo-pro', name: 'Kling v2.5 Turbo Pro', icon: 'speed', desc: 'Kling v2.5 Turbo Pro model — high speed cinematic clips', bestFor: 'Cinematic ads, temporal stability', features: ['fast', 'cinematic', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.1-i2v-pro-start-end', name: 'Kling v2.1 Start-End', icon: 'swap_horiz', desc: 'Kling v2.1 Pro Start-End Frame model — morphs two keyframes', bestFor: 'Smooth morphing, transitions', features: ['start-end-frame', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.1-t2v-master', name: 'Kling v2.1 T2V Master', icon: 'workspace_premium', desc: 'Kling v2.1 Text-to-Video Master model — premium lighting', bestFor: 'Fine text scene composition', features: ['master-cinematic', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.0-t2v-master', name: 'Kling v2.0 T2V Master', icon: 'workspace_premium', desc: 'Kling v2.0 Text-to-Video Master model — detailed scenes', bestFor: 'Human animation, detailed lightings', features: ['master-cinematic', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.1-i2v-master', name: 'Kling v2.1 I2V Master', icon: 'workspace_premium', desc: 'Kling v2.1 Image-to-Video Master model — high fidelity', bestFor: 'Realistic subject movement', features: ['master-cinematic', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.0-i2v-master', name: 'Kling v2.0 I2V Master', icon: 'workspace_premium', desc: 'Kling v2.0 Image-to-Video Master model — skin textures', bestFor: 'Fine textures and lighting consistency', features: ['master-cinematic', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.1-i2v-pro', name: 'Kling v2.1 I2V Pro', icon: 'star', desc: 'Kling v2.1 Image-to-Video Professional model', bestFor: 'Sharp creative layouts', features: ['i2v', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-2.1-i2v-std', name: 'Kling v2.1 I2V Standard', icon: 'star_border', desc: 'Kling v2.1 Image-to-Video Standard model', bestFor: 'Basic image animations', features: ['i2v', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-1.6-multi-i2v-pro', name: 'Kling v1.6 Multi Pro', icon: 'group', desc: 'Kling v1.6 Multi Image-to-Video Pro — multi-subject consistency', bestFor: 'Multi-character animations', features: ['multi-subject', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-1.6-multi-i2v-std', name: 'Kling v1.6 Multi Standard', icon: 'group', desc: 'Kling v1.6 Multi Image-to-Video Standard', bestFor: 'Multi-character layout drafts', features: ['multi-subject', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-1.6-t2v-std', name: 'Kling v1.6 T2V Standard', icon: 'videocam', desc: 'Kling v1.6 Text-to-Video Standard model', bestFor: 'UGC drafts, basic animation', features: ['t2v', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-1.6-i2v-pro', name: 'Kling v1.6 I2V Pro', icon: 'star', desc: 'Kling v1.6 Image-to-Video Professional model', bestFor: 'Early version cinematic flow', features: ['i2v', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-1.6-i2v-std', name: 'Kling v1.6 I2V Standard', icon: 'star_border', desc: 'Kling v1.6 Image-to-Video Standard model', bestFor: 'Low cost image animations', features: ['i2v', '3-15s'], available: true, recommended: false },
                                    { id: 'kling-effects', name: 'Kling Effects', icon: 'auto_awesome', desc: 'Kling Effects model — VFX and transitions', bestFor: 'Stylized motion transitions, creative effects', features: ['vfx', '3-15s'], available: true, recommended: false },
                                ].map(m => (
                                    <button key={m.id}
                                        onClick={() => {
