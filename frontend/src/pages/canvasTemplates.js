...
export const TEMPLATE_LIBRARY = [
  // ── SOCIAL POSTS ──
  { id: 't-social-1', name: 'Bold Announcement', cat: 'social', icon: '📢', layout: {
  ...
  { id: 't-social-2', name: 'Minimal Quote Card', cat: 'social', icon: '💬', layout: {
  ...
  { id: 't-social-3', name: 'Gradient Impact', cat: 'social', icon: '🔥', layout: {
  ...
  { id: 't-social-4', name: 'Tips Carousel', cat: 'social', icon: '💡', layout: {
  ...
  // ── STORIES ──
  { id: 't-story-1', name: 'Story CTA', cat: 'story', icon: '📱', layout: {
    background: '#0f172a', elements: [
  ...
  { id: 't-story-2', name: 'Story Poll', cat: 'story', icon: '📊', layout: {
  ...
  // ── AD BANNERS ──
  { id: 't-ad-1', name: 'Product Launch', cat: 'ad', icon: '🚀', layout: {
  ...
  { id: 't-ad-2', name: 'Flash Sale Banner', cat: 'ad', icon: '⚡', layout: {
  ...
  // ── SALE ──
  { id: 't-sale-1', name: 'Mega Sale', cat: 'sale', icon: '🏷️', layout: {
    background: '#0f172a', elements: [
  ...
  { id: 't-sale-2', name: 'Weekend Special', cat: 'sale', icon: '🎉', layout: {
  ...
  // ── FLYERS ──
  { id: 't-flyer-1', name: 'Modern Flyer', cat: 'flyer', icon: '📄', layout: {
  ...
  // ── EVENTS ──
  { id: 't-event-1', name: 'Conference', cat: 'event', icon: '🎤', layout: {
    background: '#0f172a', elements: [
  ...
  { id: 't-event-2', name: 'Party Invite', cat: 'event', icon: '🎊', layout: {
    background: '#0a0a0a', elements: [
  ...
  // ── BUSINESS ──
  { id: 't-biz-1', name: 'Business Card', cat: 'business', icon: '💼', layout: {
    background: '#ffffff', elements: [
  ...
  { id: 't-biz-2', name: 'Testimonial', cat: 'business', icon: '⭐', layout: {
    background: '#0f172a', elements: [
  ...
  // ── QUOTES ──
  { id: 't-quote-1', name: 'Motivational Dark', cat: 'quote', icon: '🌟', layout: {
    background: '#0a0a0a', elements: [
  ...
  { id: 't-quote-2', name: 'Elegant Serif', cat: 'quote', icon: '✨', layout: {
  ...
  { id: 't-quote-3', name: 'Bold Statement', cat: 'quote', icon: '💪', layout: {
  ...
  // ── MORE SOCIAL ──
  { id: 't-social-5', name: 'Did You Know', cat: 'social', icon: '🧠', layout: {
    background: '#0f172a', elements: [
  ...
  { id: 't-social-6', name: 'Before & After', cat: 'social', icon: '🔄', layout: {
    background: '#0f172a', elements: [
  ...
  // ── MORE AD ──
  { id: 't-ad-3', name: 'App Download', cat: 'ad', icon: '📲', layout: {
    background: '#0f172a', elements: [
  ...
  // ── MORE STORIES ──
  { id: 't-story-3', name: 'AMA Story', cat: 'story', icon: '❓', layout: {
    background: '#1e1b4b', elements: [
  ...
  // ── MORE FLYERS ──
  { id: 't-flyer-2', name: 'Restaurant Menu', cat: 'flyer', icon: '🍽️', layout: {
  ...
  // ── MORE BUSINESS ──
  { id: 't-biz-3', name: 'Thank You Card', cat: 'business', icon: '🙏', layout: {
