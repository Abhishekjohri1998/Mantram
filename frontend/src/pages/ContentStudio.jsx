...
function SmartInput({ onParse, onSkip }) {
    ...
    return (
        <div data-wt="smart-input" className="cs-centered-container text-center mb-8 cs-animate-fade">
            <div className="relative">
                ...
                <input
                    ...
                    className="cs-input-field pl-12 pr-28 py-4 text-base"
                    autoFocus
                />
