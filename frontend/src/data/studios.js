...
export const MODEL_LINEUP = {
    ...
    video: [
        ...
        { name: 'HappyHorse 1.1',    tag: 'video', vendor: 'Alibaba',   latest: true },
        { name: 'HappyHorse 1.0',    tag: 'video', vendor: 'Alibaba' },
...
export const STUDIOS = [
...

    {
        ...
        metaDesc: 'Cinematic AI video — Google Veo 3.1, Sora 2, Seedance 2.0 Pro, Kling 3.0, HappyHorse 1.1, HappyHorse 1.0. Brief to final cut. Mantram AI Video Studio.',
        aiSummary: 'Mantram Video Studio is a multi-model AI video generation platform that routes briefs to the best frontier model — Google Veo 3.1, OpenAI Sora 2, Seedance 2.0 Pro, Kling 3.0, HappyHorse 1.1, HappyHorse 1.0, Hailuo MiniMax or Wan 2.1. The pipeline runs brainstorm → script direction → reference selection → model routing → generation → optional editing. Supports text-to-video, image-to-video, video extend, and HeyGen avatar-driven UGC. Routes by quality, cost and duration constraints automatically.',
        ...
        teaser: 'Video Studio gives you Google Veo 3.1, Sora 2, Seedance 2.0 Pro, Kling 3.0, HappyHorse 1.1, HappyHorse 1.0, Hailuo MiniMax and Wan 2.1 — nine frontier models in one studio. The pipeline picks the right one for your brief based on quality, cost and duration.',
        stat: { value: '9 models', label: 'auto-routed per brief' },
        models: ['Google Veo 3.1', 'Sora 2', 'Seedance 2.0 Pro', 'Kling 3.0', 'HappyHorse 1.1', 'HappyHorse 1.0', 'Hailuo MiniMax', 'Wan 2.1', 'HeyGen Avatars'],
        useCases: [
            ...
            'Multi-shot narrative video with native audio (HappyHorse 1.1 / 1.0)',
        ],
